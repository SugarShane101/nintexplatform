...
`;
const styles = [resetCss, baseStyle];
...
let NintexSampleChartJs = _decorate([e$1('form-plugin-chart-js')], function (_initialize, _LitElement) {
  class NintexSampleChartJs extends _LitElement {
    constructor() {
      super();
      _initialize(this);
      Chart.register(ArcElement, PieController, plugin_legend, plugin_tooltip, plugin_title);
    }
  }
  return {
    F: NintexSampleChartJs,
    d: [{
      kind: "field",
      decorators: [e({
        reflect: true
